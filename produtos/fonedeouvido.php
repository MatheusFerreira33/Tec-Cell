...
if($btnCadUsuario){
	...
	if(mysqli_insert_id($conn)){
		...
		header("Location: https://mpago.la/1RcaQSN");
	}else{
...
<div class="group">
    <div id="DivA"><img src="../IMG/QWT-0488-460_zoom1.jpg"></div>
    <div id="DivLateral"><H3><b>FONE DE OUVIDO SEM FIO I12 TWS BRANCO</b></H3><p><br>
        <h4><b>Descrição:</b></h4><p>
 <font size="5">          
<b>Formato do fone: In-ear<p>
Com Bluetooth: Sim<p>
Com microfone: Sim<p>
Alcance sem fio: 10 m<p>
Impedância: 32 O<p>
Resposta em frequência: 20 Hz - 20 kHz<p>
Duração da bateria: 4 h<p>
Inclui base de carregamento: Sim<p>
Usos adequados: Esporte</b>
</font>
