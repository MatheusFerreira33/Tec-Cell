...
<div class="grande">
    <form method="post" action="processa.php">
        ...
        <input type="email" name="email" autocomplete="off" maxlength="40" required>

        <label for="email"> Telefone</label>
        <input type="text" name="telefone" autocomplete="off" maxlength="40"required>

        <label for="Texto"> Do que Precisa? </label><p>
        <textarea id="w3review" name="texto" rows="4" cols="50" value="Do que Precisa" required></textarea><br>
